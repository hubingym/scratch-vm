 ...
 *   objects
 */
exports.getScripts = function (blocks, opcode) {
...
/**
 * 该obj仅用于在typescript中,使用typeof BlocksRuntimeCache.scriptCacheObj来获取类型RuntimeScriptCache
 * @type {RuntimeScriptCache}
 */
exports.scriptCacheObj = null;

...
declare namespace Blockly {
  ...
  function defineBlocksWithJsonArray(jsonArray: any[]): void;
  ...
  let OUTPUT_SHAPE_HEXAGONAL: number;
  let OUTPUT_SHAPE_ROUND: number;
  let OUTPUT_SHAPE_SQUARE: number;
  ...
  const Blocks: {
    [index: string]: BlockDefinition | null;
  }
  ...
  class Block {
    ...
    setColour(colour: number | string, colour2?: number | string, colour3?: number | string): void;
    ...
    setDeletable(movable: boolean): void;
  ...
  class BlockSvg extends Block {
    constructor(ws: any, prototypeName: string);
  }
  ...
  class Workspace {
    ...
    scrollCenter(): void;
    highlightBlock(id: string, isGlowing?: boolean): void;
    glowBlock(id: string, isGlowing?: boolean): void;
